...
export const NotesContentTriggerCondition: React.FC<Props> = ({onConfirm, isReadOnly, value}) => {
  ...
  return (
    <>
      ...
      <OverlayEditField<NotesContentInterventionUpdate>
        ...
        disabled={isReadOnly}
        dialogTitleKey="interventions__interventions_check_notes_value_label_update_title"
